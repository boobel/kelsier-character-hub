...
const ferromagneticPullDescription: ContentBlock[] = [
  ...
  },
  {
    type: "list",
    items: [
      "Pull or Push — move an unattended metal object up to 10 lbs toward or away from you up to 10 feet.",
      "Disrupt — a creature must succeed on a Strength saving throw or have one metal weapon or piece of equipment briefly wrenched, imposing disadvantage on the next attack roll or ability check made with it before the start of your next turn.",
    ],
  },
  {
    type: "paragraph",
